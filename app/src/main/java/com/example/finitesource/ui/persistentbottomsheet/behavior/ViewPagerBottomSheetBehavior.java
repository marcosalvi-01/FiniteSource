package com.example.finitesource.ui.persistentbottomsheet.behavior;
/*
 ...
 * a bottom sheet.
 * <p>
 * See <a href="https://github.com/xcc3641/ExViewPagerBottomSheet">ExViewPagerBottomSheet</a>
 */
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
	...
	public boolean onLayoutChild(@NotNull CoordinatorLayout parent, @NotNull V child, int layoutDirection) {
		...
		mMinOffset = Math.max(0, mParentHeight - child.getHeight() + expandedOffset);
	...
	/**
	 * Sets the offset from the top of the parent this widget should scroll to when expanded.
	 *
	 * @param offset the offset in pixels from the top of the parent view when expanded
	 */
