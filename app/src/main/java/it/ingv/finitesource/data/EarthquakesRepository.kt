...
import it.ingv.finitesource.data.local.earthquake.EarthquakeDetails
import it.ingv.finitesource.data.local.earthquake.focalplane.FiniteSource
import it.ingv.finitesource.data.local.earthquake.focalplane.FocalPlane
...
import it.ingv.finitesource.data.local.earthquake.toEarthquake
import it.ingv.finitesource.data.remote.ApiCalls
import it.ingv.finitesource.data.remote.executeApiCall
import it.ingv.finitesource.okHttpClient
import it.ingv.finitesource.paletteUrl
import it.ingv.finitesource.providersUrl
