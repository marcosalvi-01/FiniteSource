...
//			val updates = mockkEarthquakesRepository.getUpdates()
//
...
//	}
	...
	private fun mockkEarthquakeRepository(testEarthquakes: List<Earthquake>): EarthquakesRepository {
		...
		val mockkScenarioTypeDao = mockk<ScenarioTypeDao>(relaxed = true)
		...
		return EarthquakesRepository(mockEarthquakeDao, mockkScenarioTypeDao, mockkApiClient)
	}
}
